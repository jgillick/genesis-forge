...
# The raycast sensor allocates per-environment buffers, so this environment needs
# more memory per environment than the sensorless examples. 4096 environments
# exceeds a 32GB machine; lower this further if you hit an allocation error.
...
def main():
    ...
    # Create environment
    env = WheeledRobotObstaclesEnv(num_envs=args.num_envs, headless=True)
