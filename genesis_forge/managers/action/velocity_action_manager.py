...
class VelocityActionManager(BaseActionManager):
    """
    Converts actions to DOF velocities, using affine transformations (scale and offset).
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._dofs_vel_buffer: torch.Tensor = None
    ...
    def handle_actions(self, actions: torch.Tensor) -> torch.Tensor:
        ...
        self.actuators.control_dofs_velocity(actions, self.dofs_idx)
